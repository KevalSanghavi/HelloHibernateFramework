...
public class OneToManyMappingApp {
	...
	public static void main(String[] args) {
		...
		OneToManyMappingApp objOneToManyMappingApp = new OneToManyMappingApp();
		...
		Integer empID1 = objOneToManyMappingApp.addEmployee("John", "Doe", 1000, set1);
		...
		Integer empID2 = objOneToManyMappingApp.addEmployee("Kevin", "Smith", 2000, set2);

		/* List down all the employees */
		objOneToManyMappingApp.listEmployees();

		/* Update employee's salary records */
		objOneToManyMappingApp.updateEmployee(empID1, 5000);

		/* Delete an employee from the database */
		objOneToManyMappingApp.deleteEmployee(empID2);
